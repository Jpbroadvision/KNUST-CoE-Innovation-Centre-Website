(function($) {
    ...
    function innovationcenterForm(argument) {
        var _hForm = $('.js-innovationcenter-form .js-innovationcenter-form__content').outerHeight() / 2;
        ...
        $('.js-innovationcenter-form .js-innovationcenter-form__content').css('bottom', -_hForm);

        if (windowWidth > 768) {
            $('.js-innovationcenter-form + *').css('padding-top', _paddingTop);
        }
    }

    innovationcenterForm();
    var myEfficientFn = debounce(function() {
        innovationcenterForm();
    }, 250);
     ...
     * Menu
     */
    $('.innovationcenter-nav').dropdownMenu({
        menuClass: 'innovationcenter-menu',
        breakpoint: 992,
        toggleClass: 'active',
    ...
    function slider() {
        ...
        if (windowWidth > 1200) {
            $('.js-innovationcenter-slider').css('marginRight', -outerPadding);
        }
    }
